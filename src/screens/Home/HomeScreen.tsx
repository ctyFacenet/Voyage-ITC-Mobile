...
const ShipOnBoard = ({ item }: { item: any }) => {
  ...
  useEffect(() => {
    if (
      item?.distanceNextPort !== null &&
      typeof item?.distanceNextPort === "number" &&
      item?.totalDistanceRun !== null &&
      typeof item?.totalDistanceRun === "number"
    ) {
      ...
      >
        ...
        >
          ...
          <Text style={styles.shipName}>
            Tàu {item?.voyage?.ship?.shipName} - {item?.voyage?.voyageCode}
          </Text>
        </View>
        <View>
          <View style={styles.imageShip}>
            <Image
              style={[styles.imageShip, { position: "relative" }]}
              source={{
                uri: environment.api_end_point_preview + "/" + item?.imageUrl,
              }}
            ></Image>
            <View
              style={{
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    ></Ionicons>
                    <Text style={{ color: "#FFFFFF", fontSize: 15 }}>
                      {item?.speed !== null ? item?.speed + " Kts" : "-"}
                    </Text>
                  </View>
                  <View
                    style={{
              ...
              >
                ...
                >
                  ...
                  <View>
                    ...
                    >
                      {item?.departurePort?.seaportName}
                    </Text>
                    <Text
                      style={{
                        color: "#40404199",
                    ...
                    >
                      {item?.itemdeparturePort?.seaportNation}
                    </Text>
                  </View>
                </View>
                ...
                >
                  ...
                  <View>
                    <Text
                      style={{ color: "#AE0000", fontSize: moderateScale(15) }}
                    >
                      {item?.seaport?.seaportName}
                    </Text>
                    <Text
                      style={{
                        color: "#40404199",
              ...
              >
                ...
                >
                  <View>
                    ...
                    >
                      ETA:{" "}
                      <Text style={{ color: "#244A64", fontSize: 17 }}>
                        {item?.eta === undefined || item?.eta === null
                          ? "-"
                          : format(new Date(item?.eta), targetDateFormat)}
                      </Text>
                    </Text>
                    <Text
                      style={{
                    ...
                    >
                      {item?.voyage?.createdAt === null
                        ? "-"
                        : item?.voyage?.createdAt}
                    </Text>
                  </View>
                </View>
              </View>
    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <Text style={styles.shipName}>
            Tàu {item?.voyage?.ship?.shipName} - {item?.voyage?.voyaegCode}
          </Text>
        </View>
        <View>
          <View style={styles.imageShip}>
              ...
              >
                ...
                >
                  ...
                  <View>
                    ...
                    >
                      {item?.seaport?.seaportNation === null
                        ? "-"
                        : item?.seaport?.seaportNation}
                    </Text>
                  </View>
        ...
        <View>
          <View style={styles.imageShip}>
            <Image
              style={[styles.imageShip, { position: "relative" }]}
              source={{
                uri: environment.api_end_point_preview + "/" + imageUrl,
              }}
            ></Image>
          </View>
          {/* Vị trí cảng */}
          ...
          >
            <Text style={{ color: "#40404199", fontSize: moderateScale(15) }}>
              Hiện tại không thực hiện Voyage
            </Text>
          </View>
        </View>
      </View>
...
const HomeScreen = () => {
  ...
  return (
    <>
      ...
      >
        <VoyageHeader
          content="Maritime Open Connect"
          iconName="user-circle"
          nameScreen="Account"
        ></VoyageHeader>

        <Modal visible={errorData} transparent={true} animationType="none">
          <View
            style={{
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: scale(13), color: "black" }}>
                Có lỗi xảy ra trong quá trình tải dữ liệu. Bạn vui lòng thử lại
                sau!
              </Text>
              <Pressable
                style={{
              ...
              >
                <Text style={{ color: "#FFFFFF", fontSize: moderateScale(15) }}>
                  Đóng
                </Text>
              </Pressable>
            </View>
            ...
            renderItem={({ item }) => {
              if (
                ...
                return (
                  <TouchableOpacity
                    onPress={() =>
                      HandlePress(
                        item.voyage.ship.id,
                        item.voyage.ship.shipName
                      )
                    }
                  >
                    <ShipOnBoard item={item}></ShipOnBoard>
                  </TouchableOpacity>
                );
                ...
                return (
                  ...
                  >
                    <ShipOnPort item={item}></ShipOnPort>
                  </TouchableOpacity>
                );
