...
const ModalConfirmPass = ({isVisibaleModalPass = false, setIsVisibaleModalPass, pass, setPass, onHandleConfirmApprove} : any) => {
      ...
      <Modal
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={{}}>Nhập mật khẩu tài khoản của bạn để tiếp tục thực hiện phê duyệt!</Text>
            <View style={styles.inputBox}>
                ...
                >
                    <Icon name={showPassword ? 'eye' : 'eye-off'} color={COLORS.text} size={20} />
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.containerBtn}>
              <TouchableOpacity
                ...
                onPress={() => setIsVisibaleModalPass(false)}
                >
              ...
              <TouchableOpacity
                ...
                <Text style={{ fontSize: moderateScale(17), color: COLORS.White }}>Xác nhận</Text>
              </TouchableOpacity>
            </View>
